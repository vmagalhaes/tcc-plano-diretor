!(function(e) {
    ...
    function(e, t, r) {
      ...
      (L.Control.Measure = L.Control.extend({
        ...
        _getMeasurementDisplayStrings: function(e) {
          ...
          return {
            polygonName: this.options.polygonName,
            lengthDisplay: t(
              e.length,
        ...
        _handleMeasureClick: function(e) {
          this.count++;
          e.count = this.count;
          this._map.fire('measureclick', e, !1);
      ...
      function n(e, t, r) {
        ...
        S || (k = 'with (obj) {\n' + k + '\n}\n'),
          ...
          (k =
            ...
            'return __p\n}');
        var A = i(function() {
          return Function(w, C + 'return ' + k).apply(void 0, L);
        });
    ...
    function(e, t, r) {
      e.exports =
        '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mede distâncias e áreas">Medidas</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Mede distâncias e áreas</h3> <ul class=tasks> <a href=# class="js-start start">Criar nova medida</a> </ul> </div> <div class=js-measuringprompt> <h3>Mede distâncias e áreas</h3> <p class=js-starthelp>Comece criando uma medida, adicionando pontos no mapa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancelar</a></li> <li><a href=# class="js-finish finish">Finalizar medida</a></li> </ul> </div> </div> ';
    },
    function(e, t, r) {
      e.exports =
        '<div class=group> <p class="lastpoint heading">Último ponto</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distância</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Área</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
    },
    function(e, t, r) {
      e.exports =
        '<h3>Localização do ponto</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta localização</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ';
    },
    function(e, t, r) {
      e.exports =
        '<h3>Medida linear</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta linha</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ';
    },
    function(e, t, r) {
      e.exports =
